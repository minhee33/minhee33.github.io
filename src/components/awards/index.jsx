...
const Award = ({ externalProjects, loading, googleAnalytics }) => {
  ...
  const renderExternalProjects = () => {
    return externalProjects.map((item, index) => (
      ...
      >
        <div className="p-8 h-full w-full flex flex-row">
          {item.icon && <img src={item.icon} width={32} />}
          <div className="flex items-center flex-col">
            <div className="w-full">
              <div className="px-4">
                <div className="text-start w-full">
                  <h2 className="font-semibold text-lg tracking-wide text-start opacity-60 mb-2">
                    {item.title}
                  </h2>
                  {/* {item.imageUrl && (
