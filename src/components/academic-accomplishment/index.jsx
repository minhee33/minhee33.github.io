...
const AcademicAccomplishment = ({
  ...
  const renderSkeleton = () => {
    let array = [];
    for (let index = 0; index < accademicAccomplishments.length; index++) {
      array.push(
  ...
  const renderExternalProjects = () => {
    return accademicAccomplishments.map((item, index) => (
      <a
            ...
            <div className="w-full">
              <div className="px-4">
                <div className="text-center w-full flex flex-col items-center gap-2">
                  {item.icon && <img src={item.icon} width={32} />}
                  <div>
  ...
  return (
    <Fragment>
      {displaySection(accademicAccomplishments) && (
...
AcademicAccomplishment.propTypes = {
  accademicAccomplishments: PropTypes.array,
